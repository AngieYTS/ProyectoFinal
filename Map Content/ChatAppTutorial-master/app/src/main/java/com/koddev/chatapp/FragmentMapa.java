 ...
 */
public class FragmentMapa extends Fragment implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
...
/*
        ...
        map.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_marcador)).anchor(0.0f, 1.0f).position(posicion).title("Hospital Susana López de Valencia"));
        map.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_marcador)).anchor(0.0f, 1.0f).position(posicion2).title("Hospital Universitario San José Ese"));
        map.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_marcador)).anchor(0.0f, 1.0f).position(posicion3).title("Cruz Roja Colombiana Seccional Cauca"));
        map.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_marcador)).anchor(0.0f, 1.0f).position(posicion4).title("Cuerpo de Bomberos Voluntarios de Popayán"));
        map.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_marcador)).anchor(0.0f, 1.0f).position(posicion5).title("Clínica La Estancia"));
        map.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_marcador)).anchor(0.0f, 1.0f).position(posicion6).title("Clínica Santa Gracia"));
        map.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_marcador)).anchor(0.0f, 1.0f).position(posicion7).title("Ambulancias S.P.A.M"));
        map.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_marcador)).anchor(0.0f, 1.0f).position(posicion8).title("IPS Comfacauca Popayán"));
        map.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_marcador)).anchor(0.0f, 1.0f).position(posicion9).title("Hospital del Norte Toribio Maya"));
    ...
    public boolean onMarkerClick(Marker marker) {/*
        if (marker.getTitle().equalsIgnoreCase(marcador.getTitle())){
            ...
            Intent siguiente = new Intent(MapsActivity.this,MainActivity.class);
